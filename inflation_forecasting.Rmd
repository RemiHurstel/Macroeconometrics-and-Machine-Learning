...
```{r}
par(mar = c(10 ,3, 1, 1))
barplot(df_mean_importance_sort$rf_importance, names.arg = df_mean_importance_sort$variable, las=2, main = 'Mean importance of each variable')
```
...
We want to have a lower MSE for the test part.
